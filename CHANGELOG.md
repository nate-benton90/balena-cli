...
* Delete repo.yml [Paulo Castro]
* Test native installers and github release [Paulo Castro]
* Add warning notices for replaced 'local' commands in v11. Also revert 'local flash'. [Paulo Castro]
