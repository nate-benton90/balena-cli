...
* Set the GitHub release name (title) for balena CI as 'balena-CLI vX.Y.Z'. This keeps the release name (title) unchanged compared to previous releases created before the transition to balena CI. [Paulo Castro]
