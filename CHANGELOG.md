...
* Feat: Check for correct architecture instead of correct device type [Alexis Svinartchouk]
* Fix: Default preload boolean parameters to false [Alexis Svinartchouk]
